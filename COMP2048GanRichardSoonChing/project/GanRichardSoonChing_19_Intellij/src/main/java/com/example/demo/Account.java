...
public class Account implements Comparable<Account> {
    ...
    {
        try{
            FileWriter fw = new FileWriter("project/GanRichardSoonChing_19_Intellij/src/main/resources/com/example/demo/Leaderboard.txt", false);
    ...
    public static void readFile() {
        try {
            BufferedReader br = new BufferedReader(new FileReader("project/GanRichardSoonChing_19_Intellij/src/main/resources/com/example/demo/Leaderboard.txt"));
    ...
    public static void write2File(){
        try{
            FileWriter fw = new FileWriter("project/GanRichardSoonChing_19_Intellij/src/main/resources/com/example/demo/Leaderboard.txt", true);
