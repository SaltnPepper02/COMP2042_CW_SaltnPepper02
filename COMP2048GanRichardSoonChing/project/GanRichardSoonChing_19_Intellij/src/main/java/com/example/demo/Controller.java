...
public class Controller implements Initializable {
    ...
    /**
     *Change scene to LeaderBoard by setting the stage with leaderboard.fxml
     * @param event on event
    ...
    /**
     * color picker to change background. Get the color value from it and put it into myColor
     * @param event on event
     */
    ...
    /**
     * Close the window by closing the stage
     * @param event on event
     */
